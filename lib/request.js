    ...
    this.$convertFieldNames = function(obj,fields){
        ...
        for(var i=0;i<lngFields;i++){
            if(isObject){
                ...
                //if(objField.value && objColumn.formatter.length>0) objField.value = self.$restfulFormatter.$processFormatters(objField.alias,objField.value,objColumn.formatter);
            }else{
